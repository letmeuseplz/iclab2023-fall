請參考lab8 lowpower design WOCG版本 但WOCG沒有EQUALIZATION。這個lab 沒有用到clock gating 也沒equalisation 剩餘整體邏輯雷同 但此版本在pipeline 管控上並沒有做好 在連續加法邏輯中間並沒有安插 會導致時序過長 很有可能會爆掉 
